...
const company74 = 'af0a310f-95a7-4a83-8194-61dfd6091219';
const company75 = '903f4c0d-e6e5-4075-b272-1e0b3813491e';
const company76 = 'fe740255-f7bb-41a3-b949-13a6b5be3669';
const company77 = '41a85045-d045-4e52-aa3b-b88583a87861';
const company78 = '3032474b-cecf-4355-a718-47258e7a283e';
...
const radioBlogsAndMediaCompanies = [
  ...
  },
  {
    ...
    phoneNumber: '',
    description:
      'Radio show aired monthly on Soho Radio, playing tracks from emerging bands or artists. Support and promote women and non-binary people in music. The show is also uploaded onto Mixcloud. Accept links to music or MP3s via the above email address. As well as the radio show, Get In Her Ears also run a website and put on shows in London.',
    address: 'London, UK',
  },
  {
    id: company74,
