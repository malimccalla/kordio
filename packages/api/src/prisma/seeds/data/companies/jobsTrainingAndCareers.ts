const company101 = '0f9fd4b9-4fc3-4bcd-b1c7-4944b8909202';
const company102 = '31469a22-043d-4d83-9df5-4fc737c8fe47';
const company103 = '26ff46fd-d6be-45b9-97c6-5fe9882d1a29';
const company104 = '487fda15-2268-46d1-a470-cd60e9c03c61';
const company105 = '06575248-dde8-4613-825a-635eae2c4b38';
const company106 = '51d75228-c910-4840-b065-1ef04f14ac7e';
const company107 = '844dd285-162f-45f7-b436-7e4064cc8f71';
const company108 = '58aa926a-e736-44ea-8ee0-60e529d92edb';
const company109 = 'a633cea4-aebb-4d1a-884c-9696afd546bc';
const company110 = '9897a1ef-83f3-43bb-941e-75af4ed025be';

export const jobsTrainingAndCareersCompanies = [
  {
    id: company101,
    name: 'The Academy Of Contemporary Music (London)',
    website: 'http://www.acm.ac.uk/',
    email: 'enquiries@acm.ac.uk',
    phone: '01483\n  500800',
    description:
  ...
  },
  {
    ...
    email: 'admin@thesongwritingacademy.co.uk',
    phone: '0330 010 0500',
    description:
  ...
  },
  {
    ...
    email: 'info@tileyardeducation.co.uk',
    phone: '07902 792740',
    description:
  ...
  },
  {
    ...
    website: '',
    email: 'soundsred@ntlworld.com',
    phone: '07956 420 711',
    description:
      'Guitar and vocal tuition. Either individual lessons or friendly group singing classes. Can provide vocal coaching for musical theatre productions, assistance with microphone techniques for stage and studio, plus preparation for auditions and recording sessions. Guitar tuition and help with songwriting. Multi-track digital recording facilities.',
  ...
  },
  {
    ...
    email: 'info@londonschoolofsound.co.uk',
    phone: '',
    description:
  ...
  },
  {
    ...
    email: 'info@londonmusicconference.org',
    phone: '',
    description:
  ...
  },
  {
    ...
    email: 'steve@musicbusinessschool.co.uk',
    phone: '',
    description:
  ...
  },
  {
    ...
    email: 'admin@themidimusiccompany.co.uk',
    phone: '020 8694 6093',
    description:
